...
// RenderButtonList renders the body between the LIST markers: one line per
// button in `buttons summary` shape — the press command and its description.
func RenderButtonList(buttons []ButtonEntry) string {
	var b strings.Builder
	b.WriteString("## Buttons in this project\n\n")
	b.WriteString("<!-- Auto-generated by `buttons create`; edits between the markers are overwritten. -->\n\n")
	if len(buttons) == 0 {
