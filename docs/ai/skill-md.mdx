...
1. **In the repo** — the [docs-sync workflow](https://github.com/autonoco/buttons/blob/main/.github/workflows/docs-sync.yml) regenerates `SKILL.md` whenever CLI code changes on main and opens a PR with updates
