---
title: "HTTP API buttons"
description: "Wrap HTTP endpoints as pressable buttons with URL templates."
---

HTTP buttons send an outbound request every time you press them. The URL, method, headers, and body are all stored in the button spec.
